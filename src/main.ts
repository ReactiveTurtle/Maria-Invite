...
const questions: readonly Question[] = [
  ...
  {
    kicker: '31 мая 2026',
    text: 'Какой момент этого дня я особенно берегу?',
    answers: ['Первый поцелуй', 'Первую прогулку', 'Первое фото', 'Первый подарок'],
      ...
      @if (screen() === 'invitation') {
        <section class="card invitation" aria-live="polite">
          ...
          <div class="invitation-detail">
            ...
            <strong>1 августа · 15:00–17:00. Хочу снова провести с тобой время, предаваясь воспоминаниям и наслаждаясь друг другом.</strong>
          </div>
